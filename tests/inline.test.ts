...
import { ImportedNumber } from "./types";
...
describe("type references", () => {
  describe(
    ...
    genTests(tg.isString, (value, expected) => {
      ...
      expect(tsguard<SomeAlias>(value)).toBe(expected);
    }),
  );
  ...
  describe(
    ...
    genTests(tg.isString, (value, expected) => {
      expect(tsguard<ImportedNumber>(value)).toBe(expected);
    }),
  );
});

describe.skip("simple types", () => {
  describe(
    "string guard",
    genTests(tg.isString, (value, expected) =>
